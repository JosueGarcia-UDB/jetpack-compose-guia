package sv.edu.udb.jetpackcomposeapp.navigation
...
import sv.edu.udb.jetpackcomposeapp.ui.theme.screens.CarrerasListScreen
import sv.edu.udb.jetpackcomposeapp.ui.theme.screens.CarreraDetailScreen
import sv.edu.udb.jetpackcomposeapp.ui.theme.screens.MateriaDetailScreen
import sv.edu.udb.jetpackcomposeapp.viewmodel.CarrerasViewModel
...
fun AppNavHost(navController: NavHostController) {
    ...
    NavHost(navController = navController, startDestination = Screen.Home.route) {
        ...
        composable(
            ...
            arguments = listOf(navArgument("carreraName") { type = NavType.StringType })
        ) { backStackEntry ->
            val carreraName = Uri.decode(backStackEntry.arguments?.getString("carreraName") ?: "")
            CarreraDetailScreen(
        ...
        composable(
            ...
            val materia = viewModel.buscarMateriasPorCodigo(codigo)
            if (materia != null) {MateriaDetailScreen(materia = materia)
            } else {
